	...
	var Todo = React.createClass({
	  ...
	  renderAllUnfinishedTasks: function () {
	    ...
	    return this.state.taskList.filter(function (task) {
	      ...
	      return React.createElement(Task, { key: task.id, task: task, completeTask: this.completeTask, updateTask: this.updateTask });
	    }.bind(this));
	  },
	  ...
	  render: function () {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'div',
	        null,
	        authenticated ? null : this.authenticationWarning()
	      ),
	      React.createElement(
	        'div',
	        null,
	      ...
	      React.createElement(
	        'div',
	        null,
	        tasksExist ? this.renderAllUnfinishedTasks() : null
	      ),
	      React.createElement(
	        'div',
	        null,
	  ...
	  render: function () {
	    return React.createElement(
	      ...
	      React.createElement("input", {
	        ...
	        type: "text",
	        onChange: function (e) {
	          this.updateTaskEmitter(this.props.task.id, e.target.value);
	        }.bind(this)
	      })
	    );
	  }
